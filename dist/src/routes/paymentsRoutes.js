...
// GET /api/payments/:paymentId/comments - Get comments for a payment
router.get('/:paymentId/comments', getPaymentComments);

// POST /api/payments/:paymentId/comments - Add a comment to a payment
router.post('/:paymentId/comments', addPaymentComment);
