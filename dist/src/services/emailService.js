...
class EmailService {
    constructor() {
        // Use environment variables for SMTP configuration with fallbacks
        const smtpConfig = {
        ...
        // IMPORTANT: Don't use 'service' property as it overrides host/port
        // Use explicit host and port configuration instead

        this.transporter = nodemailer.createTransport(smtpConfig);
        
        // Log configuration (without sensitive data)
        console.log(`📧 Email service initialized: ${smtpConfig.host}:${smtpConfig.port} (secure: ${smtpConfig.secure})`);
    }
